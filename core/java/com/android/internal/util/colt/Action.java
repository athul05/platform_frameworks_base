...
public class Action {
    ...
    public static void processActionWithOptions(Context context,
            ...
            if (action.equals(ActionConstants.ACTION_HOME)) {
                ...
                try {
                    ...
                    Log.e("EvolutionActions:", "No activity to handle assist long press action.", e);
                }
                return;
                ...
                try {
                    ...
                    Log.e("EvolutionActions:", "URISyntaxException: [" + action + "]");
                    return;
                }
                startActivity(context, intent);
                return;
    ...
    private static void startActivity(Context context, Intent intent) {
        ...
        try {
            WindowManagerGlobal.getWindowManagerService().dismissKeyguard(null /* callback */, null);
        } catch (RemoteException e) {
