...
public class DisplayPolicy {
    ...
    DisplayPolicy(WindowManagerService service, DisplayContent displayContent) {
        ...
        if (mDisplayContent.isDefaultDisplay) {
            mHasStatusBar = true;
            mHasNavigationBar = ColtUtils.deviceSupportNavigationBar(mContext);
        } else {
            mHasStatusBar = false;
    ...
    public int getTopFullscreenOpaqueWindowStatePrivateFlags() {
        return mTopFullscreenOpaqueWindowState != null ? mTopFullscreenOpaqueWindowState.getAttrs().privateFlags : 0;
    }
